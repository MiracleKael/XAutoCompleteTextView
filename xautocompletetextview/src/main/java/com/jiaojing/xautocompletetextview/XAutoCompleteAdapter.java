...
public class XAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public XAutoCompleteAdapter(Context context, ArrayList<String> mOriginalValues) {
        this(context, mOriginalValues, -1);
    }
    public XAutoCompleteAdapter(Context context, ArrayList<String> mOriginalValues, int maxMatch) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.e(TAG, "====" + mObjects.get(position));
        holder.tvHistory.setText(mObjects.get(position));      // mObject => View
    ...
    public Filter getFilter() {
        if (mFilter == null) {
            mFilter = new ArrayFilter(mFilterListener);
        }
        return mFilter;
    }
